        ...
        if (menu.equals("Productos")) {
            switch (accion) {
                ...
                case "Actualizar":
                    ...
                    int nombreUpdate = Integer.parseInt(request.getParameter("txtNombreProducto"));
                    ...
                    producto1.setNombreProducto(unidadUpdate);
                    producto1.setDescripcion(descripcionUpdate);
                    producto1.setNombreProducto(precioUpdate);
                    producto1.setUnidad(unidadUpdate);

                    producto1.setCodigo(codProducto);
                ...
                case "Cargar":
                    ...
                    Producto producto = productoDAO.ConsultaPorCodigo(codProducto);
