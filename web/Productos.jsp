...
<html lang="en">
    <head>
        ...
        <title>LIBRERIA Y PAPELERIA</title>
    </head>
    <body>
                        ...
                        <c:forEach var="producto" items="${productos}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger">Eliminar<i class="fas fa-trash-alt"></i><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-archive-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
